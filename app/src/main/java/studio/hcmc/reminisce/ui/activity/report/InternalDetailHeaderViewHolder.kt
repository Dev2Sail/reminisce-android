...
class InternalDetailHeaderViewHolder(private val viewBinding: CardCommonDetailHeaderBinding): ViewHolder(viewBinding.root) {
    constructor(parent: ViewGroup):this(
        viewBinding = CardCommonDetailHeaderBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    )

    fun bind(content: InternalDetailAdapter.HeaderContent) {
